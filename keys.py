from const import mod, groups, colors, terminal
...
utility = [
    ...
    Key([mod], "r", lazy.spawn(f"dmenu_run -sb {colors['bg1']}")),
...
keys = window_switch + window_move + window_grow + \
    layout_keys + qtile + XF86 + utility
